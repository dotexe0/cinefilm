...
function getDataFromOMDB(imdbLink) {
  ...
  $.getJSON(search, function(data){
    ...
    meta_rating = data.Metascore;
    var title = data.Title;
    console.log(title);
    console.log(meta_rating);
        ...
        $.getJSON(trailerLinksURL, function(data){
          ...
          var description =
            "<div class='cardDescription hidden'>" +
              ...
              "<a class='commonsense' target='_blank' title='Common Sense Media' href=" + commonSenseMedia + " ><i class='fa fa-check-circle-o' aria-hidden='true'></i></a><br>" +"</h3>" + meta_rating + " " + imdb_rating +
              "<h5 class='mpaa-rating'> Genre: " + genre + "</h5>" +
              "<span>" + movieDescription + "</span><br>" +
              "<div class='movieLinks'>" +
                ...
                //<img class='rottentomatoes' src='images/rottentomatoes_icon.png'></a>" +
                "<a target='_blank'  title='Metacritic' href=" + metaCritic +"><i class='fa fa-meetup fa-2x' aria-hidden='true'></i></a>" +
                //<img class='metacritic' src='images/metacritic_icon.png'></a>" +
                // "<a target='_blank' title='Common Sense Media' href=" + commonSenseMedia + " ><i class='fa fa-check-circle-o fa-2x' aria-hidden='true'></i></a><br>" +
